import HomeNav from "../components/HomeHeader";
  ...
  return (
    <>
      <div className="text-center pt-20">
        ...
        <p className="text-[var(--text-gray)] w-[65%] mx-auto">
  ...
  return (
    <div className="pt-5">
      ...
      <div className="flex gap-4 items-center justify-center">
        <Button className="px-[28px] py-[14px] rounded-full bg-white text-black cursor-pointer hover:bg-[#1a1a1a] hover:text-white duration-300">
          Get Started
        </Button>
        <Button className="px-[28px] py-[14px] rounded-full bg-[#1a1a1a] cursor-pointer duration-300 hover:bg-white hover:text-black">
          Free Consultation
        </Button>
      </div>
    </div>
